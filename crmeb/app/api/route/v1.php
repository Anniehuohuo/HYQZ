...
//    Route::get('ali_pay', 'v1.order.StoreOrderController/aliPay')->name('aliPay');
    ...
    Route::get('ai/agent_matrix', 'v1.ai.AgentMatrix/index')->middleware(\app\api\middleware\AuthTokenMiddleware::class, true)->option(['real_name' => 'AI技能课超市']);
...
Route::group(function () {
    ...
    Route::group(function () {
        Route::post('forum/posts', 'v1.forum.ForumPostController/create')->option(['real_name' => '论坛-发布帖子']);
        Route::put('forum/posts/:id', 'v1.forum.ForumPostController/update')->option(['real_name' => '论坛-编辑帖子']);
        Route::delete('forum/posts/:id', 'v1.forum.ForumPostController/delete')->option(['real_name' => '论坛-删除帖子']);
        Route::get('forum/posts/:id/edit', 'v1.forum.ForumPostController/edit')->option(['real_name' => '论坛-编辑信息']);
        Route::post('forum/posts/:id/like', 'v1.forum.ForumPostController/toggleLike')->option(['real_name' => '论坛-点赞/取消']);

        Route::post('forum/posts/:id/comments', 'v1.forum.ForumCommentController/create')->option(['real_name' => '论坛-发布评论']);
        Route::delete('forum/comments/:id', 'v1.forum.ForumCommentController/delete')->option(['real_name' => '论坛-删除评论']);

        Route::get('forum/my/posts', 'v1.forum.ForumPostController/my')->option(['real_name' => '论坛-我的帖子']);
        Route::get('forum/my/comments', 'v1.forum.ForumCommentController/my')->option(['real_name' => '论坛-我的评论']);

        Route::get('forum/drafts', 'v1.forum.ForumDraftController/lst')->option(['real_name' => '论坛-草稿箱']);
        Route::get('forum/drafts/:id', 'v1.forum.ForumDraftController/detail')->option(['real_name' => '论坛-草稿详情']);
        Route::post('forum/drafts', 'v1.forum.ForumDraftController/save')->option(['real_name' => '论坛-保存草稿']);
        Route::delete('forum/drafts/:id', 'v1.forum.ForumDraftController/delete')->option(['real_name' => '论坛-删除草稿']);
    })->option(['mark' => 'forum', 'mark_name' => '论坛']);
...
Route::group(function () {
    ...
    Route::group(function () {
        Route::get('forum/posts', 'v1.forum.ForumPostController/index')->option(['real_name' => '论坛-帖子列表']);
        Route::get('forum/posts/:id', 'v1.forum.ForumPostController/detail')->option(['real_name' => '论坛-帖子详情']);
        Route::get('forum/posts/:id/comments', 'v1.forum.ForumCommentController/lst')->option(['real_name' => '论坛-评论列表']);
    })->option(['mark' => 'forum_nologin', 'mark_name' => '论坛(未授权)']);
