...
export function getForumPosts(data) {
	return request.get('forum/posts', data, {
		noAuth: true
	})
}
...
export function getForumPostComments(id, data) {
	return request.get(`forum/posts/${id}/comments`, data, {
		noAuth: true
	})
}

export function getForumPostEdit(id) {
	return request.get(`forum/posts/${id}/edit`, {})
}
...
export function getForumMyPosts(data) {
	return request.get('forum/my/posts', data)
}

export function getForumMyComments(data) {
	return request.get('forum/my/comments', data)
}

export function getForumDrafts(data) {
	return request.get('forum/drafts', data)
}

export function getForumDraftDetail(id) {
	return request.get(`forum/drafts/${id}`, {})
}

export function saveForumDraft(data) {
	return request.post('forum/drafts', data)
}

export function deleteForumDraft(id) {
	return request.delete(`forum/drafts/${id}`, {})
}
